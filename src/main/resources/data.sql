...
INSERT INTO user (username, password, enabled) VALUES ( 'physiotherapist2@test.pl', '$2a$10$7yludK5VllyEIDmzaCpXaOBtk7eJ30kxx/vOoBz.1Twk1vZe3XuD.', 1);
INSERT INTO user (username, password, enabled) VALUES ( 'physiotherapist3@test.pl', '$2a$10$7yludK5VllyEIDmzaCpXaOBtk7eJ30kxx/vOoBz.1Twk1vZe3XuD.', 1);
...
INSERT INTO client (email,name,surname,user_id) values ('user@test.pl','Denis','Bojdol',1);
